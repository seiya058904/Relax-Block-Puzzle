...
export const QUALITY_PROFILE = 'light';
export const LOCAL_ADMIN_CODE = 'DEV-ONLY-CODE';
...
export const DRAG_FINGER_OFFSET_MULTIPLIER = 1.5;
export const DRAG_FINGER_OFFSET_MIN = 70;
export const DRAG_FINGER_OFFSET_MAX = 90;
